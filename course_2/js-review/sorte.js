...
//Sorting books by publication date in ascending order
const sortedByPublicationDate = booksApi.sort((a, b) => {
  return new Date(a.publicationDate) - new Date(b.publicationDate);
});

//Sorting books by publication date in descending order
const sortedByPublicationDateDesc = booksApi.sort((a, b) => {
  return new Date(b.publicationDate) - new Date(a.publicationDate);
});

//Sorting books by pages in ascending order
const sortedByPagesNumber = booksApi.sort((a, b) => {
  return a.pages - b.pages;
});

//Filter and sort to find the smallest fantasy book
const smallestFantasyBook = booksApi
